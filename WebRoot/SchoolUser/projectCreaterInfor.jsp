...
<%@ page import="com.GDT.Model.Teacher" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%
	String path = request.getContextPath();
	String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
	Teacher creater = (Teacher)request.getAttribute("creater_information");
%>
<html>
<head>
<base href="<%=basePath%>"></base>
<title>课题创建用户信息</title>
		...
		<div class="project_creater_body">
			<div class="tea_logon_frame">
				...
				<tr>
				  ...
				  <td align="left">
				  	<input type="radio" disabled="disabled" name="user_sex" <%=creater.getSex().equals("M") ? "checked='checked'" : "" %> class="sex_radio" value="M"/>男
				  	<input type="radio" disabled="disabled" name="user_sex" <%=creater.getSex().equals("F") ? "checked='checked'" : "" %> class="sex_radio" value="F"/>女
				  </td>
				</tr>
				<tr>
				  <td align="right">&nbsp;</td>
				...
				<tr>
                  ...
                  <td colspan="2" align="left"><div class="project_words_style"><%=creater.getResume() %></div></td>
				</tr>
