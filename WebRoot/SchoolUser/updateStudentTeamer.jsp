...
repeatTeamerObj.prototype.repeatCommit = function(repeatObj){//再次团队请求提交操作
	return function(){
		if(!repeatObj.submitSend){
			...
			DWRTeamManage.repeatCommitTeam(repeatObj.relationId , function(result){
				if(result == -1){//已达课题提交上限
					repeatObj.promptWin.confirmButtonEvent = repeatObj.errorEvent(repeatObj);
					repeatObj.promptWin.createConfirmView("<span style='color:red;'>您团队人数已达课题上限无法再邀请人员！</span>" , "确定");
					
					repeatObj.submitSend = false;
				}else if(result == 0){//已加入其他团队
					repeatObj.promptWin.confirmButtonEvent = repeatObj.errorEvent(repeatObj);
					repeatObj.promptWin.createConfirmView("<span style='color:red;'>该学生已加入其他团队无法再被邀请！</span>" , "确定");
					
					repeatObj.submitSend = false;
				}else if(result == 1){//提交团队请求成功
					repeatObj.promptWin.confirmButtonEvent = repeatObj.errorEvent(repeatObj);
					repeatObj.promptWin.createConfirmView("<span style='color:green;'>您的团队请求提交成功！</span>" , "确定");
				}else if(result == 2){//提交操作失败
					repeatObj.promptWin.confirmButtonEvent = repeatObj.errorEvent(repeatObj);
		...
		<div class="project_creater_body">
			<div class="tea_logon_frame">
				...
				<tr>
				  ...
				  <td width="76%" align="left">${studentInfor.realName }</td>
				</tr>
				<tr>
				  <td align="right">&nbsp;</td>
				  <td align="left">&nbsp;</td>
				...
				<tr>
				  ...
				  <td align="left">${studentInfor.email }</td>
				</tr>
				<tr>
				  <td align="right">&nbsp;</td>
				  <td align="left">&nbsp;</td>
				...
				<tr>
				  ...
				  <td align="left">${studentInfor.age }</td>
				</tr>
				<tr>
				  <td align="right">&nbsp;</td>
				  <td align="left">&nbsp;</td>
				...
				<tr>
				  ...
				  <td align="left">${studentInfor.phone }</td>
				</tr>
				<tr>
				  <td align="right">&nbsp;</td>
				  <td align="left">&nbsp;</td>
				...
				<tr>
				  ...
				  <td align="left">${studentInfor.qq }</td>
				</tr>
				<tr>
				  <td align="right">&nbsp;</td>
				  <td align="left">&nbsp;</td>
				...
				<div style="text-align:left;">
                	...
                	<div class="audit_more_infor" id="audit_more_infor" title="更多回复信息">More</div>
                </div>
				...
				<div class="answerView">
					...
					<tr>
					  <td width="25%" align="right">队员姓名：</td>
				...
				<div class="button_frame">
					...
					<input type="button" style="display:${teamRelation.answer eq 'F' ? '' : 'none'}" id="repeatButton" class="button_view" value="重新请求"/>
