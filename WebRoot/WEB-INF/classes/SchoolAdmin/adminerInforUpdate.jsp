...
logonSubmitObj.prototype.clickEvent = function(){
	if(checkTrueName($("true_name")) && checkPosition($("user_position")) && checkOffice($("user_office")) && checkAge($("user_age")) && checkCard($("user_card")) && checkPhone($("user_phone")) && checkEmail($("user_email")) && checkQq($("user_qq")) && !formsubmit){
		$("te_logon_form").action = "UserManageServlet?type=update_adminer_infor";
		...
		<form id="te_logon_form" method="post">
			...
			<tr>
			  ...
			  <td width="70%" align="left">
				<div class="input_frame"><input type="text" name="true_name" value="${adminInfor.realName }" id="true_name"/></div>
			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<input type="hidden" id="user_college_id" value="${adminInfor.college }"/>
			...
			<tr>
			  ...
			  <td align="left">
			  	<input type="hidden" id="user_degree_id" value="${adminInfor.degree }"/>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_position" id="user_position" value="${adminInfor.position }"/></div>
			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_office" id="user_office" value="${adminInfor.office }"/></div>
			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_email" id="user_email" value="${adminInfor.email }"/></div>
			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_age" id="user_age" value="${adminInfor.age }"/></div>
			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<input type="radio" name="user_sex" checked="checked" class="sex_radio" ${adminInfor.sex eq "M" ? "checked='checked'" : ""} value="M"/>男
			  	<input type="radio" name="user_sex" class="sex_radio" ${adminInfor.sex eq "F" ? "checked='checked'" : ""} value="F"/>女
			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_card" value="${adminInfor.idCard }" id="user_card"/></div>			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame">
			  		<input type="text" name="user_address" maxlength="50" id="user_address" value="${adminInfor.address }"/>
			  	</div>
			  </td>
			</tr>
			<tr>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_phone" id="user_phone" value="${adminInfor.phone }"/></div>			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_qq" id="user_qq" value="${adminInfor.qq }"/></div>			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td rowspan="2" align="left">
				<div class="textarea_frame">
					<textarea id="user_resume" name="user_resume" class="user_resume">${adminInfor.resume }</textarea>
				</div>
			  </td>
			</tr>
			<tr>
