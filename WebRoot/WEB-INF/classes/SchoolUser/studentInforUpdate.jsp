...
updateSubmitObj.prototype.clickEvent = function(){
	if(checkAge($("user_age")) && checkCard($("user_card")) && checkPhone($("user_phone")) && checkEmail($("user_email")) && checkQq($("user_qq")) && !formsubmit){
		$("user_update_form").action = "UserManageServlet?type=update_student_infor";
	...
	<div class="user_update_frame">
		...
		<form id="user_update_form" method="post">
			...
			<tr>
			  ...
			  <td width="70%" align="left">${studentInfor.realName }</td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">${studentInfor.college }</td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			  <td align="left">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">${studentInfor.major }</td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			  <td align="left">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_email" id="user_email" value="${studentInfor.email }"/></div>
			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_age" id="user_age" value="${studentInfor.age }"/></div>
			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<input type="radio" name="user_sex" checked="checked" class="sex_radio" ${studentInfor.sex eq "M" ? "checked='checked'" : ""} value="M"/>男
			  	<input type="radio" name="user_sex" class="sex_radio" ${studentInfor.sex eq "F" ? "checked='checked'" : ""} value="F"/>女
			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_card" value="${studentInfor.idCard }" id="user_card"/></div>			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame">
			  		<input type="text" name="user_address" maxlength="50" id="user_address" value="${studentInfor.address }"/>
			  	</div>
			  </td>
			</tr>
			<tr>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_phone" id="user_phone" value="${studentInfor.phone }"/></div>			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_qq" id="user_qq" value="${studentInfor.qq }"/></div>			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td rowspan="2" align="left">
				<div class="textarea_frame">
					<textarea id="user_resume" name="user_resume" class="user_resume">${studentInfor.resume }</textarea>
				</div>
			  </td>
			</tr>
			<tr>
