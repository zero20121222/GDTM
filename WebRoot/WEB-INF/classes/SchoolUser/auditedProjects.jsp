...
<script>
	...
	projectYearObj.prototype.clickYearAction = function(yearNum){
		return function(){
			var url = ifIE ? "../ProjectManagerServlet?type=enter_auditedPros&proYear="+yearNum : "ProjectManagerServlet?type=enter_auditedPros&proYear="+yearNum;
			window.open(url , "_self");
		}
	};
</script>
