...
updateSubmitObj.prototype.clickEvent = function(){
	if(checkOffice($("user_office")) && checkAge($("user_age")) && checkCard($("user_card")) && checkPhone($("user_phone")) && checkEmail($("user_email")) && checkQq($("user_qq")) && !formsubmit){
		$("user_update_form").action = "UserManageServlet?type=update_auditer_infor";
	...
	<div class="user_update_frame">
		...
		<form id="user_update_form" method="post">
			...
			<tr>
			  ...
			  <td width="70%" align="left">${auditerInfor.realName }</td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">${auditerInfor.college }</td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			  <td align="left">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">${auditerInfor.degree }</td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			  <td align="left">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">${auditerInfor.position }</td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_office" id="user_office" value="${auditerInfor.office }"/></div>
			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_email" id="user_email" value="${auditerInfor.email }"/></div>
			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_age" id="user_age" value="${auditerInfor.age }"/></div>
			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<input type="radio" name="user_sex" checked="checked" class="sex_radio" ${auditerInfor.sex eq "M" ? "checked='checked'" : ""} value="M"/>男
			  	<input type="radio" name="user_sex" class="sex_radio" ${auditerInfor.sex eq "F" ? "checked='checked'" : ""} value="F"/>女
			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_card" value="${auditerInfor.idCard }" id="user_card"/></div>			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame">
			  		<input type="text" name="user_address" maxlength="50" id="user_address" value="${auditerInfor.address }"/>
			  	</div>
			  </td>
			</tr>
			<tr>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_phone" id="user_phone" value="${auditerInfor.phone }"/></div>			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td align="left">
			  	<div class="input_frame"><input type="text" name="user_qq" id="user_qq" value="${auditerInfor.qq }"/></div>			  </td>
			</tr>
			<tr>
			  <td align="right">&nbsp;</td>
			...
			<tr>
			  ...
			  <td rowspan="2" align="left">
				<div class="textarea_frame">
					<textarea id="user_resume" name="user_resume" class="user_resume">${auditerInfor.resume }</textarea>
				</div>
			  </td>
			</tr>
			<tr>
