		...
		<div class="project_creater_body">
			<div class="tea_logon_frame">
				...
				<tr>
				  ...
				  <td align="left">
				  	<input type="radio" disabled="disabled" name="user_sex" ${adminInfor.sex eq "M" ? "checked='checked'" : ""} class="sex_radio" value="M"/>男
				  	<input type="radio" disabled="disabled" name="user_sex" ${adminInfor.sex eq "F" ? "checked='checked'" : ""} class="sex_radio" value="F"/>女
				  </td>
				</tr>
				<tr>
				  <td align="right">&nbsp;</td>
				...
				<tr>
                  ...
                  <td colspan="2" align="left"><div class="project_words_style">${adminInfor.resume }</div></td>
				</tr>
