...
function checkOldPassword(errorObj){
	var url = "UserManageServlet?type=check_manager_password&old_password="+$("old_password").value;
...
updateSubmitObj.prototype.clickEvent = function(updateObj){
	return function(){
		if(oldPWCheck($("old_password")) && newPWCheck($("new_password")) && newPWCheck2($("new_password2")) && !formsubmit){
			...
			var url = "UserManageServlet?type=update_manager_passowrd&old_password="+$("old_password").value+"&new_password="+$("new_password").value;
