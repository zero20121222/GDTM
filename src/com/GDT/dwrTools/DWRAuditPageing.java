 ...
 * @author zero
 */
public class DWRAuditPageing implements DWRPagingInterface{
	...
	public List<ProjectInfor> pagingByCreateName(int pageNow, int userId, int schoolId,
		...
		String sql = null;
		if(pagingType == null){//显示全部已审核的课题信息
			sql = "select 毕业课题详细信息.Id,学校Id,毕业课题名称,出题人Id,真实姓名,"
				+"参与人数限定,工作量大小,院系限定,难易程度,图片信息,课题文件下载,创建时间,题目状态 "
				+"from 毕业课题详细信息,教师详细信息,课题审核情况 where 教师详细信息.Id=出题人Id and 课题审核情况.课题Id=毕业课题详细信息.Id and 审核状态='N' "
				+"and (审核人员1="+userId+" or 审核人员2="+userId+" or 审核人员3="+userId+") and 学校Id="+schoolId
				+" and 创建时间 between '"+startTime+"' and '"+endTime+"'"
				+" and 题目状态!='S' and 题目状态!='D'"+" and 真实姓名 like '%"+createrName+"%'"
			...
			sql = "select 毕业课题详细信息.Id,学校Id,毕业课题名称,出题人Id,真实姓名,"
				+"参与人数限定,工作量大小,院系限定,难易程度,图片信息,课题文件下载,创建时间,题目状态 "
				+"from 毕业课题详细信息,教师详细信息,课题审核情况 where 教师详细信息.Id=出题人Id and 课题审核情况.课题Id=毕业课题详细信息.Id and 审核状态='N' "
				+"and (审核人员1 is null or 审核人员1!="+userId+") and (审核人员2 is null or 审核人员2!="+userId+") and (审核人员3 is null or 审核人员3!="+userId+") "
				+"and (院系类别=院系限定 or 院系限定='null') and 学校Id="+schoolId+" and 创建时间 between '"+startTime+"' and '"+endTime+"'"
				+" and 题目状态='"+pagingType+"'"+" and 真实姓名 like '%"+createrName+"%'"
				+" order by 毕业课题详细信息.Id limit "+pageNow*PAGINGCOUNTS+","+PAGINGCOUNTS;
		}
	...
	public Map<String, Integer> getPageNumberByCreateName(int userId, int schoolId, 
		...
		String sql = null;
		if(pagingType == null){//显示全部已审核的课题信息
			sql = "select count(毕业课题详细信息.Id) from 毕业课题详细信息,教师详细信息,课题审核情况 where 教师详细信息.Id=出题人Id and 课题审核情况.课题Id=毕业课题详细信息.Id and 审核状态='N' "
				+"and (审核人员1="+userId+" or 审核人员2="+userId+" or 审核人员3="+userId+") and 学校Id="+schoolId
				+" and 创建时间 between '"+startTime+"' and '"+endTime+"'"
				+" and 题目状态!='S' and 题目状态!='D'"+" and 真实姓名 like '%"+createrName+"%'";
		}else{
	...
	public List<ProjectInfor> pagingByCollege(int pageNow, int userId, int schoolId, String collegeName,
		...
		if(pagingType == null){//显示全部已审核的课题信息
			sql = "select 毕业课题详细信息.Id,学校Id,毕业课题名称,出题人Id,真实姓名,"
				...
				+"and (审核人员1="+userId+" or 审核人员2="+userId+" or 审核人员3="+userId+") and 学校Id="+schoolId
				+" and 创建时间 between '"+startTime+"' and '"+endTime+"'"
				+" and 题目状态!='S' and 题目状态!='D'"+" and 院系限定 like '%"+collegeName+"%'"
				+" order by 毕业课题详细信息.Id limit "+pageNow*PAGINGCOUNTS+","+PAGINGCOUNTS;
		}else{
	...
	public List<ProjectInfor> pagingByProjectName(int pageNow, int userId, int schoolId,
		...
		if(pagingType == null){//显示全部已审核的课题信息
			sql = "select 毕业课题详细信息.Id,学校Id,毕业课题名称,出题人Id,真实姓名,"
				...
				+"and (审核人员1="+userId+" or 审核人员2="+userId+" or 审核人员3="+userId+") and 学校Id="+schoolId
				+" and 创建时间 between '"+startTime+"' and '"+endTime+"'"
				+" and 题目状态!='S' and 题目状态!='D'"+" and 毕业课题名称 like '%"+projectName+"%'"
				+" order by 毕业课题详细信息.Id limit "+pageNow*PAGINGCOUNTS+","+PAGINGCOUNTS;
		}else{
	...
	public List<ProjectInfor> pagingByPartNum(int pageNow, int userId, int schoolId, int partNum,
		...
		if(pagingType == null){//显示全部已审核的课题信息
			sql = "select 毕业课题详细信息.Id,学校Id,毕业课题名称,出题人Id,真实姓名,"
				...
				+"and (审核人员1="+userId+" or 审核人员2="+userId+" or 审核人员3="+userId+") and 学校Id="+schoolId
				+" and 创建时间 between '"+startTime+"' and '"+endTime+"'"
				+" and 题目状态!='S' and 题目状态!='D'"+( partNum == 0 ? " " : " and 参与人数限定="+partNum)
				+" order by 毕业课题详细信息.Id limit "+pageNow*PAGINGCOUNTS+","+PAGINGCOUNTS;
		}else{
	...
	public List<ProjectInfor> pagingByHardNum(int pageNow, int userId, int schoolId, int hardNum,
		...
		if(pagingType == null){//显示全部已审核的课题信息
			sql = "select 毕业课题详细信息.Id,学校Id,毕业课题名称,出题人Id,真实姓名,"
				...
				+"and (审核人员1="+userId+" or 审核人员2="+userId+" or 审核人员3="+userId+") and 学校Id="+schoolId
				+" and 创建时间 between '"+startTime+"' and '"+endTime+"'"
				+" and 题目状态!='S' and 题目状态!='D'"+( hardNum == 0 ? "" : " and 难易程度="+hardNum)
				+" order by 毕业课题详细信息.Id limit "+pageNow*PAGINGCOUNTS+","+PAGINGCOUNTS;
		}else{
	...
	public List<ProjectInfor> pagingBySchoolId(int pageNow, int userId, int schoolId, String pagingType) {
		...
		if(pagingType == null){//显示全部已审核的课题信息
			sql = "select 毕业课题详细信息.Id,学校Id,毕业课题名称,出题人Id,真实姓名,"
				...
				+"and (审核人员1="+userId+" or 审核人员2="+userId+" or 审核人员3="+userId+") and 学校Id="+schoolId
				+" and 创建时间 between '"+startTime+"' and '"+endTime+"'"
				+" and 题目状态!='S' and 题目状态!='D' order by 毕业课题详细信息.Id limit "+pageNow*PAGINGCOUNTS+","+PAGINGCOUNTS;
		}else{
